...
/**
 * @param {JSXState} state
 * @param {import('@babel/core').NodePath} target
...
/**
 * @param {JSXState} state
 * @param {import('@babel/core').NodePath} attr
 */
...
/**
 * @param {JSXState} state
 * @param {import('@babel/types').JSXIdentifier} id
 * @param {import('@babel/core').NodePath} attr
 */
 ...
 * @returns {import('@babel/types').Identifier | import('@babel/types').MemberExpression | import('@babel/types').NullLiteral}
 */
...
/**
 * @param {JSXState} state
 * @param {import('@babel/core').NodePath} child
 */
